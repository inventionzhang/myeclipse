...
//		(new MainFunctionTripPatterns()).extractDistanceTemporalDistribution();
		...
		//excel处理
//		(new ImproveMainFunctionTripPatterns()).excelTripDistanceProcess();//出行距离相似性
...
//		(new ImproveMainFunctionTripPatterns()).extractAllTripDestinationFromExcel();//提取某时间区间内的所有trip下客点
...
//		            	String nextproDropoffStreetName = processStreetName(nextdropoffLinkIDStr);
	...
	public void extractAllTripDestinationFromExcel(){
		try {
			String exclePath1= "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\0602.xls";//读取的excel文件路径
			String txtOutPutPath1 = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\tripDropoffs0602From6To10.txt";//写入的txt文件路径
			...
			String exclePath2= "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\0603.xls";//读取的excel文件路径
			String txtOutPutPath2 = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\tripDropoffs0603From6To10.txt";//写入的txt文件路径
			...
			String exclePath3= "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\0604.xls";//读取的excel文件路径
			String txtOutPutPath3 = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\tripDropoffs0604From6To10.txt";//写入的txt文件路径
			...
			String exclePath4= "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\0605.xls";//读取的excel文件路径
			String txtOutPutPath4 = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\tripDropoffs0605From6To10.txt";//写入的txt文件路径
			...
			String mergeTxtOutPutPath = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\tripDropoffs060205From6To10.txt";//写入的txt文件路径
	...
	public void extractTripDestinationFromExcelAccordingTimeInterval(String exclePath, String sheetNameStr, String txtOutPutPath,
		...
		try {			
            ...
            for (int i = 1; i < rowCount; i++) {
            	...
            	String hourStr = curLocalTimeStr.substring(11, 13);
            	int intHour = Integer.parseInt(hourStr);
            	int timePeriod = obtainHourPeriod6To10(intHour);//	            	            	
            	String dropoffLinkIDStr = sheet.getCell(2, i).getContents();
//	            	String proDropoffStreetName = processStreetName(dropoffLinkIDStr);
            	if (timePeriod == 1) {
            	...
            	for (int j = i + 1; j < rowCount; j++) {	            		
	            	...
	            	String nexthourStr = nextLocalTimeStr.substring(11, 13);
	            	int nextIntHour = Integer.parseInt(nexthourStr);
	            	int nextTimePeriod = obtainHourPeriod6To10(nextIntHour);
//		            	String nextpickupLinkIDStr = sheet.getCell(2, j).getContents();
//		            	String nextproPickupStreetName = processStreetName(nextpickupLinkIDStr);		            	
	            	String nextdropoffLinkIDStr = sheet.getCell(2, j).getContents();
//		            	String nextproDropoffStreetName = processStreetName(nextdropoffLinkIDStr);
...
//					rightStr = tleftStr + trightStr;
	 ...
	 * @return
	 */
	public int obtainHourPeriod6To10(int intHour){
		int timePeriod = -1;
		try {
			if(intHour >= 6 && intHour < 10){
				timePeriod = 1;
			}
		} catch (Exception e) {
			// TODO: handle exception
...
//	        String LDATopicPath = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffsFrom4To10\\LDAprocess.xlsx";
	        ...
	        String topicProbabilityFieldStr = "Topic005Prob";//主题概率名
	        String LDATopicPath = "F:\\360云盘\\Experiment\\LDA\\tripPatterns\\tripDropoffs060205From6To10\\LDAprocess.xlsx";
