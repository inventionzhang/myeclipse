...
//		threadPoolSaveTravelTimeToTxtFile(1);//线程池：统计目标路段通行时间，保存在txt文件中
...
//		saveTaxiInfosToText();
	 ...
	 * 因此，首选获得所有外包矩形范围allLinkBoundingRectangleMap
	 */
		...
		try {
        	...
        	while (iterator.hasNext()) {
        		...
        		for (int j = 0; j < returnLinkTravelTimeArrayList.size(); j++) {
        			...
        			int linkID = returnLinkTravelTime.getLinkID();//fileGeodatabase中ID与shapefile中ID相差1
